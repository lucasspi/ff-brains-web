...
module.exports = {
  /* 01.General */
  'general.copyright': 'Spirandeli © 2018 Todos Direitos Reservados.',

  'unauthorized.title': 'Acesso não autorizado',
  'unauthorized.detail':
    'Você não está autorizado a visualizar a página que está tentando acessar.',
  ...
  'user.email': 'E-mail',
  'user.password': 'Senha',
  'user.forgot-password-question': 'Esqueci a Senha?',
  'user.fullname': 'Nome Completo',
  'user.login-button': 'LOGIN',
  'user.register-button': 'CADASTRO',
  'user.reset-password-button': 'RESET',
  'user.buy': 'IR PARA LOJA',
  'user.username': 'Username',
  'user.new-password-again': 'Nova Senha Novamente',
  'user.new-password': 'Nova Senha',
  'user.reset-password': 'Reset Senha',
  /* 03.Menu */
  'menu.home': 'Home',
  'menu.app': 'Home',
  ...
  'menu.forgot-password': 'Esqueci senha',
  'menu.error': 'Erro',
  'menu.applications': 'Aplicações',
  'menu.todo': 'Lista de A Fazer',
  'menu.survey': 'Survey',
  'menu.chat': 'Chat',
  'menu.ui': 'UI',
  'menu.alerts': 'Alertas',
  ...
  'menu.form-components': 'Formulários Components',
  'menu.form-validations': 'Formulários Validations',
  'menu.form-wizard': 'Formulários Wizard',
  'menu.icons': 'Icones',
  ...
  'menu.hidden': 'Escondido',
  'menu.visible': 'Visivel',
  'menu.maps': 'Mapas',
  ...
  'menu.blank-page': 'Página em Branco',
  ...
  'menu.authorization': 'Autorização',
  'menu.profile': 'Perfil',
  ...
  'dashboards.magic-is-in-the-details': 'Welcome to Brains',
